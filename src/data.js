...
export const about = {
	new: {
		en: {
			title: (
				<span>
					I am a <strong>Software developer</strong> who:
				</span>
			),
			bullet: [
				{
					header: (
						<React.Fragment>
							is <strong>analytical</strong> and <strong>pays attention to detail</strong>
						</React.Fragment>
					),
	...
	sortedSkills: {
		...
		Backend: ['Node.js', 'RESTful API', 'GraphQL', 'MySQL', 'PostgreSQL', 'MongoDB', 'PHP'],
...
export const contactData = {
	...
	description: {
		...
		ja: <p className="col-12">どんなことでも、お気軽にご連絡いただけますと嬉しいです。</p>
	},
	name: {
		en: 'Name',
		ja: 'お名前'
...
const portfolioDetail = [
	{
		...
		description: {
			en: 'Single page application that helps Japanese learners to practice Japanese.',
			ja: ''
		},
		summary: {
			en:
	...
	},
	{
		...
		skills: ['React', 'API'],
		description: {
			en: 'Suggests routes between two locations and calculates carbon footprint.',
			ja: ''
		},
		additionalDescription: {
			en: 'Project at Girls in Tech Vancouver Hacking for Humanity Hackathon 2019. (My role: Frontend)',
			ja: ''
		},
		summary: {
			en:
...
export const portfolioData = portfolioDetail.filter((data) => data.display).sort((a, b) => {
